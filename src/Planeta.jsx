...
const Planeta = ({caracteristicas, func, indice}) => {
  ...
  return (
    <div className='grid-item' onClick={() => func(caracteristicas)}>
        ...
        :
            <img className={`equis ${caracteristicas.seleccionado ? 'seleccionado animate__animated animate__shakeX animate__faster' : ''}`} src='public/exercise-1/x.png' alt={caracteristicas.nombre} />  
        }
